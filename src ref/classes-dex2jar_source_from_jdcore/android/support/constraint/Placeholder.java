  ...
  extends View
{
  ...
  private int mDefaultVisibility = 4;
  ...
  private void init(AttributeSet paramAttributeSet)
  {
    ...
    if (paramAttributeSet != null)
    {
      ...
      while (i < j)
      {
        ...
        if (k == R.styleable.ConstraintLayout_Layout_content) {
  ...
  public void setDefaultVisibility(int paramInt)
  {
    mDefaultVisibility = paramInt;
  }
