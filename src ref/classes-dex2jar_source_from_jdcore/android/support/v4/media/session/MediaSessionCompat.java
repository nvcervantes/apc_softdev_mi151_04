...
public class MediaSessionCompat
{
  ...
  public MediaSessionCompat(Context paramContext, String paramString, ComponentName paramComponentName, PendingIntent paramPendingIntent)
  {
    ...
    {
      mImpl = new MediaSessionImplApi19(paramContext, paramString, localComponentName, paramComponentName);
    }
    else if (Build.VERSION.SDK_INT >= 18)
    {
      mImpl = new MediaSessionImplApi18(paramContext, paramString, localComponentName, paramComponentName);
    }
    else
    {
      mImpl = new MediaSessionImplBase(paramContext, paramString, localComponentName, paramComponentName);
    }
    mController = new MediaControllerCompat(paramContext, this);
    if (sMaxBitmapSize == 0) {
      ...
      implements MediaSessionCompatApi21.Callback
    {
      ...
      public void onCommand(String paramString, Bundle paramBundle, ResultReceiver paramResultReceiver)
      {
        try
        {
          ...
          {
            paramResultReceiver = (MediaSessionCompat.MediaSessionImplApi21)mSessionImpl.get();
    ...
    extends MediaSessionCompat.MediaSessionImplBase
  {
    ...
    void setRccState(PlaybackStateCompat paramPlaybackStateCompat)
    {
      ...
      mRcc.setPlaybackState(getRccStateFromState(paramPlaybackStateCompat.getState()), l1, f);
    }
        ...
        for (;;)
        {
          synchronized (mLock)
          {
            ...
            else
            {
              ...
              k = mAudioManager.getStreamVolume(n);
              break label123;
