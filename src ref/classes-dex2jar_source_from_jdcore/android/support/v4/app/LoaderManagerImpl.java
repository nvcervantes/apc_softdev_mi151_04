  ...
  extends LoaderManager
{
  ...
  @MainThread
  @NonNull
  private <D> Loader<D> createAndInstallLoader(int paramInt, @Nullable Bundle paramBundle, @NonNull LoaderManager.LoaderCallbacks<D> paramLoaderCallbacks)
  {
    try
    {
      mCreatingLoader = true;
      Object localObject = paramLoaderCallbacks.onCreateLoader(paramInt, paramBundle);
      ...
      paramBundle = new LoaderInfo(paramInt, paramBundle, (Loader)localObject);
      if (DEBUG)
      {
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append("  Created new loader ");
  ...
  public <D> Loader<D> initLoader(int paramInt, @Nullable Bundle paramBundle, @NonNull LoaderManager.LoaderCallbacks<D> paramLoaderCallbacks)
  {
    ...
    if (localLoaderInfo == null) {
      return createAndInstallLoader(paramInt, paramBundle, paramLoaderCallbacks);
    }
    if (DEBUG)
    {
      paramBundle = new StringBuilder();
    ...
    implements Loader.OnLoadCompleteListener<D>
  {
    ...
    LoaderInfo(int paramInt, @Nullable Bundle paramBundle, @NonNull Loader<D> paramLoader)
    {
      mId = paramInt;
      mArgs = paramBundle;
      mLoader = paramLoader;
