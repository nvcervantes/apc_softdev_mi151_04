...
public class NotificationCompat
{
  ...
  static Action getActionCompatFromAction(Notification.Action paramAction)
  {
    ...
    return new Action(icon, title, actionIntent, paramAction.getExtras(), arrayOfRemoteInput, null, bool);
  }
  ...
  public static class Action
  {
      ...
      implements NotificationCompat.Action.Extender
    {
      ...
      private void setFlag(int paramInt, boolean paramBoolean)
      {
        ...
        mFlags = ((paramInt ^ 0xFFFFFFFF) & mFlags);
      }
  ...
  public static class Builder
  {
    ...
    private void setFlag(int paramInt, boolean paramBoolean)
    {
      ...
      flags = ((paramInt ^ 0xFFFFFFFF) & flags);
    }
    ...
    extends NotificationCompat.Style
  {
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      ...
      if (Build.VERSION.SDK_INT >= 24)
      {
        localObject1 = new Notification.MessagingStyle(mUserDisplayName).setConversationTitle(mConversationTitle);
