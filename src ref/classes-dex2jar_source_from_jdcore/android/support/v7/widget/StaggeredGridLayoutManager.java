  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  private void measureChildWithDecorationsAndMargin(View paramView, LayoutParams paramLayoutParams, boolean paramBoolean)
  {
    if (mFullSpan)
    {
      if (mOrientation == 1)
      {
        measureChildWithDecorationsAndMargin(paramView, mFullSizeSpec, getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), height, true), paramBoolean);
        return;
      }
      measureChildWithDecorationsAndMargin(paramView, getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), width, true), mFullSizeSpec, paramBoolean);
      return;
    }
    if (mOrientation == 1)
    {
      measureChildWithDecorationsAndMargin(paramView, getChildMeasureSpec(mSizePerSpan, getWidthMode(), 0, width, false), getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), height, true), paramBoolean);
      return;
    }
    measureChildWithDecorationsAndMargin(paramView, getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), width, true), getChildMeasureSpec(mSizePerSpan, getHeightMode(), 0, height, false), paramBoolean);
  }
  ...
  public void collectAdjacentPrefetchPositions(int paramInt1, int paramInt2, RecyclerView.State paramState, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry)
  {
    ...
    if (getChildCount() != 0)
    {
      ...
      paramInt2 = 0;
      int i;
      for (paramInt1 = paramInt2; paramInt2 < mSpanCount; paramInt1 = i)
      {
        int j;
  ...
  public int[] findFirstCompletelyVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    {
      localObject = new int[mSpanCount];
    }
    else
    {
      ...
      if (paramArrayOfInt.length < mSpanCount)
      {
        ...
        ((StringBuilder)localObject).append(mSpanCount);
    ...
    while (i < mSpanCount)
    {
      localObject[i] = mSpans[i].findFirstCompletelyVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public int[] findFirstVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    while (i < mSpanCount)
    {
      localObject[i] = mSpans[i].findFirstVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public int[] findLastCompletelyVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    while (i < mSpanCount)
    {
      localObject[i] = mSpans[i].findLastCompletelyVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public int[] findLastVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    while (i < mSpanCount)
    {
      localObject[i] = mSpans[i].findLastVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, View paramView, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
  {
    ...
    paramAccessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, k, i, mFullSpan, false));
  }
  ...
  public void setMeasuredDimension(Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    if (mOrientation == 1)
    {
      ...
      i = chooseSize(paramInt1, mSizePerSpan * mSpanCount + i, getMinimumWidth());
      paramInt1 = paramInt2;
      paramInt2 = i;
    }
    else
    {
      ...
      i = chooseSize(paramInt2, mSizePerSpan * mSpanCount + j, getMinimumHeight());
      paramInt2 = paramInt1;
      paramInt1 = i;
    }
  ...
  static class LazySpanLookup
  {
    ...
    public FullSpanItem getFirstFullSpanItemInRange(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
    {
      ...
      while (i < j)
      {
        ...
        if ((mPosition >= paramInt1) && ((paramInt3 == 0) || (mGapDir == paramInt3) || ((paramBoolean) && (mHasUnwantedGapAfter)))) {
          return localFullSpanItem;
        }
        i += 1;
      }
