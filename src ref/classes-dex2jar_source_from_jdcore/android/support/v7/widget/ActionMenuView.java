  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    int i12 = mMinCellSize + i2 % paramInt1 / m;
    ...
    while (i5 < i8)
    {
      ...
      else
      {
        ...
        i4 = measureChildForCells((View)localObject, i12, m, i7, i6);
        i1 = Math.max(i3, i4);
        m = j;
        if (expandable) {
          m = j + 1;
