...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>>
{
  ...
  private void animateViewOut(final int paramInt)
  {
    if (Build.VERSION.SDK_INT >= 12)
    {
      ...
      ((ValueAnimator)localObject).setIntValues(new int[] { 0, mView.getHeight() });
    ...
    Object localObject = android.view.animation.AnimationUtils.loadAnimation(mView.getContext(), R.anim.design_snackbar_out);
  ...
  void animateViewIn()
  {
    if (Build.VERSION.SDK_INT >= 12)
    {
      ...
      if (USE_OFFSET_API) {
        ViewCompat.offsetTopAndBottom(mView, i);
      } else {
        mView.setTranslationY(i);
      }
      localObject = new ValueAnimator();
    ...
    Object localObject = android.view.animation.AnimationUtils.loadAnimation(mView.getContext(), R.anim.design_snackbar_in);
    ((Animation)localObject).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ((Animation)localObject).setDuration(250L);
    ((Animation)localObject).setAnimationListener(new Animation.AnimationListener()
    {
