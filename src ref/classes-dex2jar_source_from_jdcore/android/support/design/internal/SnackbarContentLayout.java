  ...
  implements BaseTransientBottomBar.ContentViewCallback
{
  ...
  public void animateContentIn(int paramInt1, int paramInt2)
  {
    ...
    ViewPropertyAnimator localViewPropertyAnimator = mMessageView.animate().alpha(1.0F);
    long l1 = paramInt2;
    ...
    if (mActionView.getVisibility() == 0)
    {
      ...
      mActionView.animate().alpha(1.0F).setDuration(l1).setStartDelay(l2).start();
    }
  }
  ...
  public void animateContentOut(int paramInt1, int paramInt2)
  {
    ...
    ViewPropertyAnimator localViewPropertyAnimator = mMessageView.animate().alpha(0.0F);
    long l1 = paramInt2;
    localViewPropertyAnimator = localViewPropertyAnimator.setDuration(l1);
    long l2 = paramInt1;
    localViewPropertyAnimator.setStartDelay(l2).start();
    if (mActionView.getVisibility() == 0)
    {
      ...
      mActionView.animate().alpha(0.0F).setDuration(l1).setStartDelay(l2).start();
    }
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = mMessageView.getLayout().getLineCount();
    int j = 1;
    if (paramInt1 > 1) {
      paramInt1 = 1;
    } else {
