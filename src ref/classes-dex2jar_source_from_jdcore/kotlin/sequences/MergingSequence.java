  ...
  implements Sequence<V>
{
  ...
  {
    sequence1 = paramSequence;
    sequence2 = paramSequence1;
    transform = paramFunction2;
  }
  ...
  public Iterator<V> iterator()
  {
    (Iterator)new Iterator()
    {
      ...
      public V next()
      {
        return MergingSequence.access$getTransform$p(this$0).invoke(iterator1.next(), iterator2.next());
      }
