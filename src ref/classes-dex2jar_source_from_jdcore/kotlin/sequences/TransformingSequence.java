  ...
  implements Sequence<R>
{
  ...
  public final <E> Sequence<E> flatten$kotlin_stdlib(@NotNull Function1<? super R, ? extends Iterator<? extends E>> paramFunction1)
  {
    ...
    return (Sequence)new FlatteningSequence(sequence, transformer, paramFunction1);
  }
  ...
  public Iterator<R> iterator()
  {
    (Iterator)new Iterator()
    {
      ...
      public R next()
      {
        return TransformingSequence.access$getTransformer$p(this$0).invoke(iterator.next());
      }
