...
public enum CharCategory
{
  ...
  protected CharCategory(int paramInt, @NotNull String paramString)
  {
    value = paramInt;
    code = paramString;
  }
  ...
  {
    return Character.getType(paramChar) == value;
  }
