...
class ComparisonsKt__ComparisonsKt
{
  ...
  private static final <T, K> Comparator<T> compareBy(Comparator<? super K> paramComparator, final Function1<? super T, ? extends K> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      ...
      {
        return $comparator.compare(paramFunction1.invoke(paramAnonymousT1), paramFunction1.invoke(paramAnonymousT2));
      }
    };
  }
  ...
  private static final <T> Comparator<T> compareBy(Function1<? super T, ? extends Comparable<?>> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
      {
        return ComparisonsKt.compareValues((Comparable)$selector.invoke(paramAnonymousT1), (Comparable)$selector.invoke(paramAnonymousT2));
      }
    };
  }
  ...
  public static final <T> Comparator<T> compareBy(@NotNull Function1<? super T, ? extends Comparable<?>>... paramVarArgs)
  {
    ...
    int i;
    if (((Object[])paramVarArgs).length > 0) {
      i = 1;
    } else {
      i = 0;
    }
    ...
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
      {
        return ComparisonsKt__ComparisonsKt.access$compareValuesByImpl(paramAnonymousT1, paramAnonymousT2, $selectors);
      }
    };
  }
  ...
  private static final <T, K> Comparator<T> compareByDescending(Comparator<? super K> paramComparator, final Function1<? super T, ? extends K> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
      {
        return $comparator.compare(paramFunction1.invoke(paramAnonymousT2), paramFunction1.invoke(paramAnonymousT1));
      }
    };
  }
  ...
  private static final <T> Comparator<T> compareByDescending(Function1<? super T, ? extends Comparable<?>> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
      {
        return ComparisonsKt.compareValues((Comparable)$selector.invoke(paramAnonymousT2), (Comparable)$selector.invoke(paramAnonymousT1));
      }
    };
  }
  ...
  public static final <T> Comparator<T> nullsFirst(@NotNull Comparator<? super T> paramComparator)
  {
    ...
    (Comparator)new Comparator()
    {
      public final int compare(@Nullable T paramAnonymousT1, @Nullable T paramAnonymousT2)
      {
        ...
        return $comparator.compare(paramAnonymousT1, paramAnonymousT2);
      }
    };
  }
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramComparator, "$receiver");
  ...
  @NotNull
  public static final <T> Comparator<T> then(@NotNull Comparator<T> paramComparator, @NotNull final Comparator<? super T> paramComparator1)
  {
    Intrinsics.checkParameterIsNotNull(paramComparator, "$receiver");
    ...
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
      {
        int i = receiver$0.compare(paramAnonymousT1, paramAnonymousT2);
        if (i != 0) {
          return i;
        }
  ...
  @InlineOnly
  private static final <T, K> Comparator<T> thenBy(@NotNull Comparator<T> paramComparator, final Comparator<? super K> paramComparator1, final Function1<? super T, ? extends K> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
  ...
  @InlineOnly
  private static final <T> Comparator<T> thenBy(@NotNull Comparator<T> paramComparator, final Function1<? super T, ? extends Comparable<?>> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
  ...
  @InlineOnly
  private static final <T, K> Comparator<T> thenByDescending(@NotNull Comparator<T> paramComparator, final Comparator<? super K> paramComparator1, final Function1<? super T, ? extends K> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
  ...
  @InlineOnly
  private static final <T> Comparator<T> thenByDescending(@NotNull Comparator<T> paramComparator, final Function1<? super T, ? extends Comparable<?>> paramFunction1)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
  ...
  @InlineOnly
  private static final <T> Comparator<T> thenComparator(@NotNull Comparator<T> paramComparator, final Function2<? super T, ? super T, Integer> paramFunction2)
  {
    (Comparator)new Comparator()
    {
      public final int compare(T paramAnonymousT1, T paramAnonymousT2)
  ...
  @NotNull
  public static final <T> Comparator<T> thenDescending(@NotNull Comparator<T> paramComparator, @NotNull final Comparator<? super T> paramComparator1)
  {
    Intrinsics.checkParameterIsNotNull(paramComparator, "$receiver");
    Intrinsics.checkParameterIsNotNull(paramComparator1, "comparator");
    (Comparator)new Comparator()
