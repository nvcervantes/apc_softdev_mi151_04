...
class SequenceBuilderKt__SequenceBuilderKt
{
  ...
  @NotNull
  public static final <T> Iterator<T> buildIterator(@NotNull Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> paramFunction2)
  {
  ...
  @SinceKotlin(version="1.1")
  @NotNull
  public static final <T> Sequence<T> buildSequence(@NotNull Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> paramFunction2)
  {
    Intrinsics.checkParameterIsNotNull(paramFunction2, "builderAction");
    (Sequence)new Sequence()
    {
      ...
      {
        return SequenceBuilderKt.buildIterator($builderAction$inlined);
      }
    };
  }
}
