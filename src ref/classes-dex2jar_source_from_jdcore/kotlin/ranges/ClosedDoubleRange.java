  ...
  implements ClosedFloatingPointRange<Double>
{
  ...
  {
    _start = paramDouble1;
    _endInclusive = paramDouble2;
  }
  
  public boolean contains(double paramDouble)
  {
    return (paramDouble >= _start) && (paramDouble <= _endInclusive);
  }
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if ((paramObject instanceof ClosedDoubleRange)) {
      if ((!isEmpty()) || (!((ClosedDoubleRange)paramObject).isEmpty()))
      {
        ...
        if ((d != _start) || (_endInclusive != _endInclusive)) {}
      }
      else
      {
        return true;
  ...
  {
    return Double.valueOf(_endInclusive);
  }
  
  @NotNull
  public Double getStart()
  {
    return Double.valueOf(_start);
  }
  ...
  public int hashCode()
  {
    ...
    return 31 * Double.valueOf(_start).hashCode() + Double.valueOf(_endInclusive).hashCode();
  }
