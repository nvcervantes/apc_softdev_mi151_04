  ...
  implements RandomAccess
{
  ...
  {
    AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(paramInt1, paramInt2, list.size());
    fromIndex = paramInt1;
    _size = (paramInt2 - paramInt1);
  }
}
