  ...
  extends AbstractMutableList<T>
{
  ...
  {
    delegate.add(CollectionsKt__ReversedViewsKt.access$reversePositionIndex(this, paramInt), paramT);
  }
  ...
  {
    return delegate.remove(CollectionsKt__ReversedViewsKt.access$reverseElementIndex(this, paramInt));
  }
  
  public T set(int paramInt, T paramT)
  {
    return delegate.set(CollectionsKt__ReversedViewsKt.access$reverseElementIndex(this, paramInt), paramT);
  }
}
