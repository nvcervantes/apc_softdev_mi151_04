  ...
  implements Closeable
{
  ...
  private List<Header> readHeaderBlock(int paramInt1, short paramShort, byte paramByte, int paramInt2)
    throws IOException
  {
    ContinuationSource localContinuationSource = continuation;
    ...
    throws IOException
  {
    ...
    paramHandler.pushPromise(paramInt2, source.readInt() & 0x7FFFFFFF, readHeaderBlock(lengthWithoutPadding(paramInt1 - 4, paramByte, s), s, paramByte, paramInt2));
  }
    ...
    throws IOException
  {
    ...
    {
      paramHandler = source.readByteString(Http2.CONNECTION_PREFACE.size());
      if (logger.isLoggable(Level.FINE)) {
    ...
    implements Source
  {
      ...
      throws IOException
    {
      ...
      if (Http2Reader.logger.isLoggable(Level.FINE)) {
        Http2Reader.logger.fine(Http2.frameLog(true, streamId, length, b, flags));
      }
