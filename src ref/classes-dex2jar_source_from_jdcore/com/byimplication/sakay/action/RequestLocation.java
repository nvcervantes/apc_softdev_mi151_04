  ...
  implements Action
{
  ...
  public RequestLocation(boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  @NotNull
  public final RequestLocation copy(boolean paramBoolean1, boolean paramBoolean2)
  {
    return new RequestLocation(paramBoolean1, paramBoolean2);
  }
  ...
  public boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof RequestLocation))
      {
        paramObject = (RequestLocation)paramObject;
        int i;
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("RequestLocation(shouldMoveMap=");
