  ...
  implements Action
{
  ...
  public SetWork(@NotNull LatLng paramLatLng, @Nullable String paramString1, @Nullable String paramString2, boolean paramBoolean)
  {
  ...
  @NotNull
  public final SetWork copy(@NotNull LatLng paramLatLng, @Nullable String paramString1, @Nullable String paramString2, boolean paramBoolean)
  {
    Intrinsics.checkParameterIsNotNull(paramLatLng, "location");
    return new SetWork(paramLatLng, paramString1, paramString2, paramBoolean);
  }
  ...
  public boolean equals(Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof SetWork))
      {
        paramObject = (SetWork)paramObject;
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("SetWork(location=");
