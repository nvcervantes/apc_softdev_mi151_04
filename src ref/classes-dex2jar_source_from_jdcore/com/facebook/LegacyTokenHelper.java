...
final class LegacyTokenHelper
{
    ...
    throws JSONException
  {
    ...
    else
    {
      ...
      bool = localObject2 instanceof byte[];
      int j = 0;
      int k = 0;
      int m = 0;
      int n = 0;
      ...
      else
      {
        ...
        if ((localObject2 instanceof char[]))
        {
          ...
          for (;;)
          {
            ...
            ((JSONArray)localObject1).put(String.valueOf(localObject2[i]));
            i += 1;
          }
        }
        if ((localObject2 instanceof List))
        {
          ...
          for (;;)
          {
            ...
            ((JSONArray)localObject1).put(paramBundle);
          }
        }
        paramBundle = null;
        localObject1 = str;
  ...
  public Bundle load()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      catch (JSONException localJSONException)
      {
        ...
        Logger.log((LoggingBehavior)localObject, 5, str2, localStringBuilder.toString());
        return null;
      }
    }
